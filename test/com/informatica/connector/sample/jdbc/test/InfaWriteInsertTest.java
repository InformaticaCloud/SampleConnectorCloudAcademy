...
public class InfaWriteInsertTest {
	...
	// Flag to tell the test if ObjectName_Insert.csv is not found then use
...
//DO NOT MAKE ANY CHANGES BELOW THIS 	
	...
	public void testInsert() {
		try
		{
			String TestInterface = "Write"; //Valid values are Write/Update/Upsert/Delete
