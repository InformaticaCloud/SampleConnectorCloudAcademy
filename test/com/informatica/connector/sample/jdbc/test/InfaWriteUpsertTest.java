...
public class InfaWriteUpsertTest {
	...
	// Flag to tell the test if ObjectName_Upsert.csv is not found then use
...
//DO NOT MAKE ANY CHANGES BELOW THIS 	
	...
	public void testUpsert() {
		try
		{
			String TestInterface = "Upsert"; //Valid values are Write/Update/Upsert/Delete
