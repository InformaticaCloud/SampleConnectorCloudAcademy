...
public class InfaWriteDeleteTest {
	...
	// Flag to tell the test if ObjectName_Delete.csv is not found then use
...
//DO NOT MAKE ANY CHANGES BELOW THIS 	
	...
	public void testDelete() {
		try
		{
			String TestInterface = "Delete"; //Valid values are Write/Update/Upsert/Delete
